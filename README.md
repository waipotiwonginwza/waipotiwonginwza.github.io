...
<body>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>invade/vade/อินเวด/เวด/เหวดำ</td>
                <td>คำกริยา</td>
                <td>การไปรุกรามพื้นที่ฟาร์มป่าของฝั้งตรงข้าม</td>
            </tr>
            <tr>
                <td>จบบน</td>
                <td>คำกริยา</td>
                <td>ตำแหน่งป่าฝั่งตรงข้ามฟามจบที่เลนบน</td>
            </tr>
            <tr>
                <td>ขวย</td>
                <td>คำนาม</td>
                <td>คำที่ใข้ด่ากันมีความหมายอวัยวะเพศชาย</td>
            </tr>
            <tr>
                <td>ดราฟ</td>
                <td>คำกริยา</td>
                <td>การเลือกตัวละครไปสู้กับทีมตรงข้ามหรือการวางแผนในการเอาตัวละครไปใช้</td>
            </tr>
            <tr>
                <td>ไดร์ฟ/โถม/drive</td>
                <td>คำกริยา</td>
                <td>การที่ทีมเราไปรุมตัวละครของฝั่งตรงข้ามที่มีน้อยกว่าทีมเรา</td>
            </tr>
            <tr>
                <td>DPS/ดีพีเอส</td>
                <td>คำนาม</td>
                <td>Damage per second ดาเมจต่อวินาทีที่ทำได้</td>
            </tr>
            <tr>
                <td>cc/ซีซี</td>
                <td>คำนาม</td>
                <td>สกิลที่ทำให้ทีมตรงข้ามโดรสตั้นหรือไม่สามารถทำอะไรได้</td>
            </tr>
            <tr>
                <td>Bait/เบท</td>
                <td>คำกริยา</td>
                <td>การล่อทีมตรงข้ามให้ตามมา</td>
            </tr>
            <tr>
                <td>ล้าง</td>
                <td>คำกริยา</td>
                <td>การล้างCCหรือล้างสถานะผิดปกติให้เพื่อน</td>
            </tr>
            <tr>
                <td>ตัดเลือด</td>
                <td>คำนาม</td>
                <td>ของที่สามารถลดค่าการฮีลเลือดของทีมตรงข้ามได้</td>
            </tr>
            <tr>
                <td>ฮีล/Heal</td>
                <td>คำกริยา</td>
                <td>การรีเลือดทำให้พลังชีวิตของตัวเองฟื้นฟู</td>
            </tr>
            <tr>
                <td>ของโรม</td>
                <td>คำนาม</td>
                <td>ของที่ตำแหน่งโรมมิ่งออกมาช่วยทีมซึ่งมีหลายชนิดเช่นล้างเปิดแมพฮีลหรือเกราะซึ่งของโรมจะมีสามารถพิเศษคือไม่แย่งเงินจากเพื่อนในทีม</td>
            </tr>
            <tr>
                <td>Split lane</td>
                <td>คำกริยา</td>
                <td>แยกไปเลนตรงข้ามหรือไปดันเลนตรงข้ามที่เพื่อนอยู่</td>
            </tr>
            <tr>
                <td>Freeze wave/แช่เลน</td>
                <td>คำกริยา</td>
                <td>แช่เลนหรือการทำให้ครีปตีกันโดยที่เราไม่เครียร์ครีปยู่</td>
            </tr>
            <tr>
                <td>Ultimate/ULT/อันติ/อันติเมต</td>
                <td>คำกริยา</td>
                <td>สกิลอันติหรือท่าไม้ตาย</td>
            </tr>
            <tr>
                <td>ครีป/Creep</td>
                <td>คำนา่ม</td>
                <td>เป็นมีนเนียนที่ป้อมใหญ่เราสร้างขึ้นมาและเมื่อเราตีครีปจนตายเราจะได้เงิน</td>
            </tr>
            <tr>
                <td>ป้อม</td>
                <td>คำนา่ม</td>
                <td>ป้อมคือฐานของทั้งสองทีมซึ่งมีป้อมใหญ่กับป้อมเล็กซึ่งแต่ละทีมจะมีอยู่สิบป้อม</td>
            </tr>
            <tr>
                <td>ป้อม</td>
                <td>คำกริยา</td>
                <td>สกิลติดคลูดาวน์คือสกิจไม่พร้อมใช้งานต้องรอเวลา</td>
            </tr>
            </tbody>
    </table>
